...
app.use(cors({
  origin: [process.env.CLIENT_URL || 'http://localhost:5174', 'http://localhost:5173', 'http://localhost:3000', 'https://fitnexo-6is2.vercel.app/login', 'https://fitnexo-6is2.vercel.app'],
  credentials: true,
}))
